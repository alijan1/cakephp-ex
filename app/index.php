...
<title>-=[ Gull Hassan ]=-</title>
<!-- The snow.css file animates the snow -->
<link rel="stylesheet" href="b.css" type="text/css" media="screen" charset="utf-8">
...
private function one($url){
	...
	CURLOPT_USERAGENT => 'SCRIPT CREATED BY -=[ Gull Hassan ]=-',
));
...
<br><font color="white"> Welcome To My Site:</font><font color="yellow"> '.$nm.' </font></br>
...
<body><div style="font-family: Aladin;font-size: 35pt;text-shadow: 0 0 11px #09dbea, 0 0 11px #09dbea, 0 0 11px #09dbea;color: #FFF"><font color="blue" size="10"><font size="75"<b> <script language="JavaScript" src="champ.js" size="520"></script></b></font></font><br><center></h3>
<center';
}
...
<div id="message">
<p class="text2">
     <a target="_blank" href="http://ios-token1.byethost18.com">Click Here fOr Token</a></br>
     <a target="_blank" href="https://www.facebook.com/gull1100/">Click Here fOr ConTacT Owner</a>
...
<div id="footer">
<font style="font-family: Aladin;font-size: 20pt;text-shadow: 0 0 11px #8b814c, 0 0 11px #8b814c, 0 0 11px #8b814c;color: red">  Bot Users : </font> <font style="font-family: Aladin;font-size: 20pt;text-shadow: 0 0 11px #8b814c, 0 0 11px #8b814c, 0 0 11px #8b814c;color="red">'.count($user).'</font><br>

<font style="font-family: Aladin;font-size: 20pt;text-shadow: 0 0 11px #8b814c, 0 0 11px #8b814c, 0 0 11px #8b814c;color: red"> Powered By : </font> <font style="font-family: Aladin;font-size: 20pt;text-shadow: 0 0 11px #8b814c, 0 0 11px #8b814c, 0 0 11px #8b814c;color="red">Gul Hassan</font>
...
?>
<audio src="http://links.papapk.net/English_songs/Justin%20Bieber/Baby(Acoustic).mp3" autoplay="" loop=""></audio>
</audio>                                                                                                                                                                                                                                                                                                                                                                  
